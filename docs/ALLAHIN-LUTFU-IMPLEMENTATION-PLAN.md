...
- **[2026-09-05 NORMAL TAMBUR + ÖZEL MENÜ DENETİMİ; 2026-09-12 TRICKSTER EYE DÜZELTMESİ]** Normal tamburdan doğrudan coin tamamen kaldırıldı; açılış şeridi yalnız ödeme sembolü, Odin’s Eye karşılığı Nur Gözü ve Scatter üretir. Coin ve bütün coin modifier’ları Eye/FU/Collector kaynaklı Mystery çözüm şeridine aittir. Resmî Odin’s Vault sayfası Tricksterspin'i 75× maliyetli bir volatilite anahtarı olarak tanımlar fakat kapalı Eye yüzdesini yayımlamaz. Aynı stüdyonun resmî Hel’s Domain açıklamasında Trickster Spin'in çekirdek çarpan sembolünden en az ikisini garanti etmesi, Trickster karakterinin çekirdek özellik frekansını görünür biçimde yükseltmesi gerektiğine dair karşılaştırmalı dayanak olarak kullanıldı. Hilebaz Dönüş sabit seed ölçümünde %58,26 Eye görülen tur ve tur başına 0,667 Eye üretir: çoğunlukla 1, seyrek 2, çok nadir 3 Eye. Ödeme ölçeği Eye oranından bağımsız kalibre edilerek 60.000 turda yaklaşık %96,70 RTP korunur. Altı seçenekli özel oyun menüsü resmî 3×/25×/75×/5.000×/200×/1.000× yapısını tek ekranda gösterir.
...
28. `coin-flight`: her kaynak üzerindeki ham coin değeri `×` olarak sütun okuma sırasıyla keseye uçar; coin yüzünde veya uçuşunda `PR` gösterilmez.
...
- [x] Normal tambur coin’den arındırıldı; Eye/Scatter her mod için ayrı oranlandı. Hilebazda Eye'lı tur oranı normalin yaklaşık %35 seviyesinden %58,26'ya çıkarıldı; çoğunlukla 1, seyrek 2 ve çok nadir 3 Eye üreten tempo ayrı RTP ölçeğiyle %96,70 çevresinde tutuldu. Altı kartlı özel oyun menüsü eklendi.
