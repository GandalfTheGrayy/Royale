...
export default function SimulationProposalReview({ recommendation, request, goal, disabled, onBusy, onApply }: {
  ...
  return <article className="sim-proposal-review">
    ...
    <p>Öneri paketinin sonucu, içinden tek bir ayarı uygulamanın sonucu değildir. Bu yüzden seçiminiz güncel canlı profile karşı önce 6 ayrı tohumla yeniden ölçülür. Sonuç umut verici fakat belirsizse motor kendiliğinden 10 tohuma ve daha yüksek tur sayısına çıkar. Ortak ayarlarda diğer modlar da kontrol edilir.</p>
