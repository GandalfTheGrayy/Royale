        ...
        <div className="allah-modal-backdrop" role="presentation" onMouseDown={(event) => event.target === event.currentTarget && setRulesOpen(false)}>
          <section className="allah-modal allah-rules-modal" role="dialog" aria-modal="true" aria-labelledby="allah-rules-title">
            ...
            <div className="allah-rules-grid">
              ...
              <article><b>Alan / Global Çarpan</b><p>Alan Çarpanı bir hücre yarıçapındaki coin ve dolu keseleri tek tek büyütür. Her Semavi Anahtar üç haneyi sırayla yeniden döndürür; aynı zincirde ikinci anahtar gelirse üç yeni değer mevcut hanelere eklenir. Hane toplamı çizgi, coin ve Collector kazancına gerçekten uygulanır. Ödeme öncesinde saha yukarıdan aşağı taranır; her satırdaki coin ve dolu keseler eski değer × Global Çarpan işlemiyle yeni değerine görünür biçimde dönüşür.</p></article>
